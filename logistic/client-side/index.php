...
<nav>
    ...
    <ul>
        ...
        <li><button class="nav-btn" data-content="project_tracker">Projects</button></li>
    ...
    <div class="logout-container">
        <a href="login.php" class="logout" onclick="return confirm('Are you sure you want to logout?')">
